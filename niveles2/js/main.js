...
$('#checkAll').addEventListener('click',()=>{
  ...
  if(allOk){
    ...
    localStorage.setItem('completedLevels', JSON.stringify({ level1: localStorage.getItem('completedLevels') ? JSON.parse(localStorage.getItem('completedLevels')).level1 : false, level2: true }));
...
function toggleMusic() {
  ...
  function redirectToPage() {
    ...
    function gomap() {
      window.location.href = '../secciones/niveles2.html'; // Or replace with actual URL
    }